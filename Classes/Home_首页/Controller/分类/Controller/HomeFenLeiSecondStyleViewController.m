//
//  HomeFenLeiSecondStyleViewController.m
//  Himalayas_FM
//
...
@interface HomeFenLeiSecondStyleViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation HomeFenLeiSecondStyleViewController
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 40, Screen_Width, Screen_Height-40-49) collectionViewLayout:flowLayout];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        cell.xiDian.text = [NSString stringWithFormat:@"%.2lf喜点",list.price];
