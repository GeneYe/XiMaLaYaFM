...
- (instancetype)initWithFrame:(CGRect)frame SelecterConditionTitleArray:(NSArray *)titleArray andTypeStyle:(TypeStyle)typeStyle andBtnBlock:(BtnClick)btnClick{
    ...
    if (self = [super init]) {
        ...
        self.backgroundColor = ViewControllerBlackgroundColor;
        self.frame = frame;
        ...
        for (int i = 0 ; i < titleArray.count; i++) {
            ...
            [titleBtn setTitleColor:GYCommonBgColor forState:UIControlStateNormal];
        ...
        _bottomScrollLine.backgroundColor = GYCommonBgColor;
